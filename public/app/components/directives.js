...
var app = angular.module('CA4App.directives', [])
...
app.directive("wikiDetails", function () {
    //For the practice, wouldn't be better to use.??
    return {
        restrict: "AE",
        templateUrl: "../directives/wikiDetails.html"
    }
